...
export default function QuickView({ open, setOpen, id }) {
  ...
  const [like, setLike] = useState(board[0].total_number_of_likes);
  const [bookmark, setBookmark] = useState(board[0].total_number_of_bookmarks);
                      ...
                      >
                        <div className="flex sm:flex-col1">
                          <button
                            ...
                            onClick={() => {
                              dispatch(savePost(board[0].author, id));
